...
class NotificationSerializer(serializers.ModelSerializer):
    type = serializers.CharField(source="event_type", help_text="Event type: task_assigned, task_unassigned, mention, comment_added, status_changed, deadline_warning, summary_ready.")
